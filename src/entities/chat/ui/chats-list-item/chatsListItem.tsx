...
export const ChatsListItem: React.FC<IChatsListItem> = ({ isRead, content, chatId }) => {
    ...
    >
      <div className="flex items-center">
        ...
        <div className="pl-2.5">
          <span className="text-primaryGreen-main font-bold text-xs">Пользователь</span>
          <p className="text-black text-xs font-weight">{content}</p>
        </div>
      </div>
      <span className="text-grey-40 text-xs">14:40</span>
    </div>
  );
};
