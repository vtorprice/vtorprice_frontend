...
export function useField<Value>(field: Field<Value>): ConnectedField<Value> {
  ...
  return {
    ...
    addError: useEvent(field.addError),
    validate: useEvent(field.validate),
    reset: useEvent(field.reset),
    set: useEvent(field.onChange),
    resetErrors: useEvent(field.resetErrors),
...
export function useForm<Values extends AnyFormValues>(
  ...
  return {
    ...
    error,
    errorText,
    reset: useEvent(form.reset),
    submit: useEvent(form.submit),
    setForm: useEvent(form.setForm),
    set: useEvent(form.setForm), // set form alias
    formValidated: useEvent(form.formValidated),
  } as Result<Values>;
}
