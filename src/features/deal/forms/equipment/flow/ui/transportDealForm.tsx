...
import {BaseInput, Checkbox, DisabledView, TabSelect} from "@box/shared/ui";
...
const TransportDealForm: FC<{ deliveryPrice?: number, contractor?: string }> = ({contractor, deliveryPrice}) => {
